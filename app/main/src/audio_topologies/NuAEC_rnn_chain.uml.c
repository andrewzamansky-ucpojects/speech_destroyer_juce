...
char upsample_filter_left[] = "upsample_filter_left";

#ifndef UPSAMPLE_OUTPUT_TO_48000
...
{ rnn_left, RNN_DSPT, SET_INPUTS( IN0(nuvoton_aec, 0) ) },
{ rnn_gain, MULTIPLIER_1CH_DSPT, SET_INPUTS( IN0(rnn_left, 0) ) },
{ upsample_filter_left, UPSAMPLING_BY_INT_DSPT, SET_INPUTS( IN0(rnn_gain, 0) )},
{ passthrough_gain, MULTIPLIER_1CH_DSPT,
		SET_INPUTS( IN0(chain_inputs, 0) ) },
{ chain_outputs, CHAIN_OUTPUTS_DSPT ,
	SET_INPUTS( IN0(passthrough_gain, 0), IN1(upsample_filter_left, 0) ) },
};
