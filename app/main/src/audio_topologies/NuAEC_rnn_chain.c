...
void init_chain()
{
	...
	struct upsampling_by_int_api_set_params_t upsample_set_params;
	...
	downsample_set_params.predefined_data_block_size = 128;
	...
	upsample_set_params.input_sample_rate_Hz = 16000;
	upsample_set_params.output_sample_rate_Hz = 48000;
	upsample_set_params.number_of_coefficients_in_lowpass_filter = 25;
	upsample_set_params.predefined_data_block_size = 128;
	dsp_management_api_ioctl_1_params(
			pMain_dsp_chain, upsample_filter_left,
