...
static uint8_t zero_buff_for_DSP_chain[ZERO_BUFF_SIZE_FOR_DSP_CHAIN];
static uint8_t dummy_buff_for_DSP_chain[DUMMY_BUFF_SIZE_FOR_DSP_CHAIN];
		...
		size_t *samples_to_record)
{
	...
	memcpy(output_buff_right, output_buff_left,
					rec_num_of_samples * sizeof(float));
